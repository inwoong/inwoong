...
MFCApplication5Doc.h, MFCApplication5Doc.cpp - 문서
    ...
    문서에는 다음과 같은 문자열이 있습니다.
        파일 확장명:      TEST
        파일 형식 ID:        MFCApplication5.Document
        주 프레임 캡션:  MFCApplication5
        Doc 형식 이름:       MFCApplication5
        필터 이름:         MFCApplication5 Files (*.TEST)
        파일의 새 약식 이름: MFCApplication5
        파일 형식의 긴 이름: MFCApplication5.Document
...
res\MFCApplication5Doc.ico
    아이콘 파일이며, CMFCApplication5Doc 클래스 MDII 자식 창의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 MFCApplication5.rc에 의해 포함됩니다.
